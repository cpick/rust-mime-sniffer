...
const MAGIC_XML: &'static [Magic] = &[Magic::String("application/xhtml+xml",
...
mod tests {
    ...
    fn test_invalid_office_docs() {
        ...
        assert_eq!(Some("application/msword"),
                   sniff_for_invalid_office_docs(b"\xD0\xCF\x11\xE0\xA1\xB1\x1A\xE1\x00\x00",
                                                 "application/msword"));
        assert_eq!(Some("application/octet-stream"),
